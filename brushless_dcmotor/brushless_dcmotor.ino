// Project: driving a cd-writer brushless dc motor using Arduino and LD298
//          hall sensor is used to detect position
//
// Author: Y.Shen, 8.7.2014

// set pin numbers:
const int ledPin =  13;      // the number of the LED pin
const int hallPin[]={A0,A1,A2,A3,A4,A5};
